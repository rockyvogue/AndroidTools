...
public class WifiapBroadcast extends BroadcastReceiver {
    ...
    public void onReceive(Context paramContext, Intent paramIntent) {
        ...
        // wifi开关
        if (WifiManager.WIFI_STATE_CHANGED_ACTION.equals(paramIntent
                .getAction())) {
            int wifiState = paramIntent.getIntExtra(
        ...
        // 连接wifi
        else if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(paramIntent
                .getAction())) {
