...
public class MyListView extends ListView implements OnScrollListener {
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            case RELEASE_To_REFRESH:
                ...
                tipsTextview.setText(R.string.list_refresh);
            ...
            case PULL_To_REFRESH:
                ...
                if (isBack) {
                    ...
                    tipsTextview.setText(R.string.list_pull_refresh);
                } else {
                    tipsTextview.setText(R.string.list_pull_refresh);
                }
                break;
            ...
            case REFRESHING:
                ...
                tipsTextview.setText(R.string.list_doing_refresh);
                lastUpdatedTextView.setVisibility(View.VISIBLE);
    ...
    public void onRefreshComplete() {
        state = DONE;
        lastUpdatedTextView.setText(R.string.list_recently_refresh
