...
public class ListMenuLayout extends FrameLayout {
    ...
    public ListMenuLayout(View contentView, ListMenuView menuView) {
    ...
    private ListMenuLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    private ListMenuLayout(Context context) {
        super(context);
    }
    ...
    public ListMenuView getMenuView() {
        return mMenuView;
    }
