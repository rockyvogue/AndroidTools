...
import com.spt.carengine.activity.LocationOverlayActivity;
import com.spt.carengine.activity.RouteOverlayActivity;
...
public class BaiduMapSdk {
	...
	public static void showRoute(Context context,boolean hasMap, String mode, double fromLat, double fromLng, String fromCity,
