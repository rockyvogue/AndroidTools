...
import com.spt.carengine.voice.utils.VoiceUtils;
...
public class GifDrawalbe extends AnimationDrawable {
    ...
    public GifDrawalbe(Context context, int id) {
        ...
        setBounds(0, 0,
                VoiceUtils.dip2px(context, helper.getImage().getWidth() / 2),
                VoiceUtils.dip2px(context, helper.getImage().getHeight() / 2));
