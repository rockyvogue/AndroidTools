...
public class PlayPauseDrawable extends Drawable {
    ...
    private static final Property<PlayPauseDrawable, Float> PROGRESS = new Property<PlayPauseDrawable, Float>(
    ...
    public PlayPauseDrawable(Context context) {
        ...
        mPauseBarDistance = res
                .getDimensionPixelSize(R.dimen.pause_bar_distance);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        final float barWidth = lerp(mPauseBarWidth, mPauseBarHeight / 2f,
                mProgress);
        // The current position of the left pause bar's top left coordinate.
        final float firstBarTopLeft = lerp(0, barWidth, mProgress);
        // The current position of the right pause bar's top right coordinate.
        final float secondBarTopRight = lerp(2 * barWidth + barDist, barWidth
                + barDist, mProgress);
        ...
        // bounds.
        canvas.translate(mWidth / 2f - ((2 * barWidth + barDist) / 2f), mHeight
                / 2f + (mPauseBarHeight / 2f));
    ...
    public Animator getPausePlayAnimator() {
        final Animator anim = ObjectAnimator.ofFloat(this, PROGRESS,
                mIsPlay ? 1 : 0, mIsPlay ? 0 : 1);
    ...
    public void resize(float mPauseBarWidth, float mPauseBarHeight,
            float mPauseBarDistance) {
