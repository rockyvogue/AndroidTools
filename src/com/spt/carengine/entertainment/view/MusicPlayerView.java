...
public class MusicPlayerView extends View implements OnPlayPauseToggleListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // We resize play/pause drawable with button radius. button needs to be
        // inside circle.
        mPlayPauseDrawable.resize((1.2f * mButtonRadius / 5.0f),
                (3.0f * mButtonRadius / 5.0f) + 10.0f, (mButtonRadius / 5.0f));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Draw cover image
        float radius = mCenterX <= mCenterY ? mCenterX - 75.0f
                : mCenterY - 75.0f;
        ...
        if (mProgressVisibility) {
            ...
            canvas.drawArc(rectF, 145, calculatePastProgressDegree(), false,
                    mPaintProgressLoaded);
            ...
            canvas.drawText(leftTime,
                    (float) (mCenterX * Math.cos(Math.toRadians(35.0)))
                            + mWidth / 2.0f - mRectText.width() / 1.5f,
                    (float) (mCenterX * Math.sin(Math.toRadians(35.0)))
                            + mHeight / 2.0f + mRectText.height() + 15.0f,
                    mPaintTime);
            ...
            canvas.drawText(passedTime,
                    (float) (mCenterX * -Math.cos(Math.toRadians(35.0)))
                            + mWidth / 2.0f - mRectText.width() / 3.0f,
                    (float) (mCenterX * Math.sin(Math.toRadians(35.0)))
                            + mHeight / 2.0f + mRectText.height() + 15.0f,
                    mPaintTime);
